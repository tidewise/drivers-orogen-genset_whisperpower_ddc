...
#ifndef GENSET_WHISPERPOWER_DDC_TASK_TASK_HPP
...
tasks/Task.cpp, and will be put in the genset_whisperpower_ddc namespace.
     * \details
     * The name of a TaskContext is primarily defined via:
     \verbatim
     deployment 'deployment_name'
         task('custom_task_name','genset_whisperpower_ddc::Task')
     end
     \endverbatim
    ...
    protected:
        ...
        bool isGeneratorRunning(GeneratorState const& state);
    ...
    public:
         ...
         */
        Task(std::string const& name = "genset_whisperpower_ddc::Task");
